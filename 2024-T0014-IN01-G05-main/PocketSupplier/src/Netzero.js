class Netzero extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("formC1_img", "assets/Netzero/Form1_Netzero.png");
    this.load.image("formC2_img", "assets/Netzero/Form2_Netzero.png");
    this.load.image("formC3_img", "assets/Netzero/Form3_Netzero.png");
    this.load.image("formC4_img", "assets/Netzero/Form4_Netzero.png");
  }
  ...
  create() {
    ...
    this.prancheta = this.physics.add
