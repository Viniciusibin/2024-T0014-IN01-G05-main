class Political extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("formB1_img", "assets/Political/Form1_Political.png");
    this.load.image("formB2_img", "assets/Political/Form2_Political.png");
    this.load.image("formB3_img", "assets/Political/Form3_Political.png");
    this.load.image("formB4_img", "assets/Political/Form4_Political.png");
  }

  // Adicionando os elementos
  create() {
    this.add
      .image(gameState.larguraJogo / 2.9, gameState.alturaJogo / 2.03, "fundo")
      .setScale(1.1);

    // Adicionando a imagem da "Prancheta"
    var prancheta = this.physics.add
      .sprite(1180, 293, "prancheta_img")
      .setScale(2);
    ...
    this.formAberto_1 = this.physics.add
      .sprite(500, 500, "formB1_img")
      .setScale(1.0);
    ...
    this.formAberto_2 = this.physics.add
      .sprite(500, 500, "formB2_img")
      .setScale(1.0);
    ...
    this.formAberto_3 = this.physics.add
      .sprite(500, 500, "formB3_img")
      .setScale(1.0);
    ...
    this.formAberto_4 = this.physics.add
      .sprite(500, 500, "formB4_img")
      .setScale(1.0);
